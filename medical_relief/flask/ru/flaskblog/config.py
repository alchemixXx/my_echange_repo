...
MYSQL_DATABASE_HOST = 'http://127.0.0.1:5000'
...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = f'mysql+pymysql://{MYSQL_DATABASE_USER}:{MYSQL_DATABASE_PASSWORD}@{MYSQL_DATABASE_HOST}/db_medical_relief'
